...
The icon button component is a reusable React component for creating interactive buttons in your web application.

## Props

The Icon Button component accepts the following props:
